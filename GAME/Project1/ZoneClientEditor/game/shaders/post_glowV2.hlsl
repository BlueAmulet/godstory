...

{
   ...
   OUT.UV2 = float4(Coord.x, Coord.y + TexelIncrement,
             Coord.x, Coord.y - TexelIncrement);
   TexelIncrement += TexelIncrement;
   OUT.UV3 = float4(Coord.x, Coord.y + TexelIncrement,
             Coord.x, Coord.y - TexelIncrement);
   TexelIncrement += TexelIncrement;
   OUT.UV4 = float4(Coord.x, Coord.y + TexelIncrement,
             Coord.x, Coord.y - TexelIncrement);
