...
Fragout main( ConnectData IN,
              ...
              uniform sampler    baseWaterTex      : register(S4),
...
)
{
   ...
   bumpNorm += (tex2D(bumpMap, IN.texCoord2.xy) * 2.0 - 1.0) * 0.3;
   ...
   float4 baseTexColor = tex2D( baseWaterTex, IN.texCoord2.zw );
   OUT.col = refractColor * baseTexColor;
