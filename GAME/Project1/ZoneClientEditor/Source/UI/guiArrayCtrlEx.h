...
class GuiArrayCtrlEx : public GuiControl
{
...
public:
   ...
   GuiArrayCtrlEx();
   DECLARE_CONOBJECT(GuiArrayCtrlEx);
   ...
   virtual int  getRowNumber(S32 nCellIndex)	 { return 0; }
   virtual int  getRowCount(S32 nCellIndex = -1) { return 0; }
   virtual int  getEntryIndex(S32 nRowIndex)	{ return 0; }
