...
$RSSFeed::serverName = "feeds.FireRain.com";
$RSSFeed::serverPort = 80;
$RSSFeed::serverURL  = "/product/PowerEngine";
$RSSFeed::userAgent = "PowerEngine/1.1";
...
{
   // This function occasionally makes PowerEngine hard crash. It doesn't
