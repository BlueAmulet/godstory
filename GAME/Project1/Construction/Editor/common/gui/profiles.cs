...
if(!isObject(GuiTextProfile_1)) new GuiControlProfile (GuiTextProfile_1)
{
	 justify = "center";
	 borderColor = "0 0 0";
   fontColor = "0 0 0";
...
if(!isObject(GuiTextEditProfile_1)) new GuiControlProfile (GuiTextEditProfile_1)
{
   opaque = true;
   fillColor = "255 255 255";
   fillColorHL = "128 128 128";
...
if(!isObject(GuiTextEditSliderProfile)) new  GuiControlProfile (GuiTextEditSliderProfile : GuiTextEditProfile)
{
	 textOffset = "0 0";
	 bitmap = "./images/EditSlider";
};

if(!isObject(GuiNumericEditProfile)) new GuiControlProfile (GuiNumericEditProfile : GuiTextEditProfile)
{
   opaque = true;
};
...
if(!isObject(EditorGuiGamePlayProfile)) new GuiControlProfile (EditorGuiGamePlayProfile : GuiContentProfile)
{
   fontType = "Arial";
   fontSize = 14;
};
