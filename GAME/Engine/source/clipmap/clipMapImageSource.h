...
public:
   ...
   virtual const U32 getMipLevelCount()=0;
   ...
   virtual bool isDataAvailable(const U32 mipLevel, const RectI region)=0;
   ...
   virtual F32 texelOffset()=0;
	virtual void drawTex(const U32 mipLevel, const RectI srcRegion, GFXTexHandle &tex){}
};
