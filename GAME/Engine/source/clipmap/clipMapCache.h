...
public:
   ...
   virtual void beginRectUpdates(ClipMap::ClipStackEntry &cse)=0;
   ...
   virtual void doRectUpdate(U32 mipLevel, ClipMap::ClipStackEntry &cse, RectI srcRegion, RectI dstRegion)=0;
