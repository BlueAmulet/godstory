...
//----------------------------------------------------------------------------
CTinyStream& operator << ( CTinyStream& stream, Polyhedron& v )
{
	int length;
	length = v.edgeList.size();
	stream << length;
	...
	length = v.planeList.size();
	stream << length;
	for( int i = 0; i < length; i++ )
	{
		stream << v.planeList[i];
	}

	length = v.pointList.size();
	stream << length;
	for( int i = 0; i < length; i++ )
	{
		stream << v.pointList[i];
	}
