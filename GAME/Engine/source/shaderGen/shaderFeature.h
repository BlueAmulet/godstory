...
public:
   ...
   */
   ...
   void setupTBVar(MultiLine * meta);
...
/// Vertex color
//**************************************************************************
class VertexColor : public ShaderFeature
{
public:
	virtual void processVert( Vector<ShaderComponent*> &componentList,
		GFXShaderFeatureData &fd );
...
/// specular map
//**************************************************************************
class SpecularMapFeat : public ShaderFeature
{
public:
...
/// ColorExposure
//**************************************************************************
class ColorExposureFeat : public ShaderFeature
{
public:
    virtual void processPix( Vector<ShaderComponent*> &componentList, GFXShaderFeatureData &fd );
    virtual Material::BlendOp getBlendOp(){ return Material::None; }
