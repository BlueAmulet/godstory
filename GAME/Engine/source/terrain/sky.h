...
//--------------------------------------------------------------------------
class Sky : public RenderableSceneObject
{
  ...
  private:
	...
	StringTableEntry mScreenMaskName;
	...
	F32 mObjSenseDistance;		//Ray: Pack/Unpack
    U32 mNumFogVolumes;
  ...
  public:
   ...
   F32 getStaticObjDistance() const { return mStaticObjDistance; }
   F32 getObjSenseDistance() const { return mObjSenseDistance; }
   ColorF GetGlowColor();
   StringTableEntry getScreenMask(){return mScreenMaskName;}
...
private:
	//prerender
	static GFXStateBlock* mRenderSetSB;
	static GFXStateBlock* mRenderSet2SB;
	static GFXStateBlock* mRenderClearSB;
	//render
	static GFXStateBlock* mAlphaBlendFalseSB;
	//renderSkyBox
	static GFXStateBlock* mRenderSkyBoxSetSB;
	static GFXStateBlock* mSkyBoxTexSB;
	static GFXStateBlock* mSkyBoxClearSB;//新加，防止水等物体渲染时，没有进行z裁剪
	//renderBans
	static GFXStateBlock* mBansSetSB;
public:
	static void init();
	static void shutdown();
	//
