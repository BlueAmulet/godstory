...
namespace TerrBatch
{
   ...
   extern GFXAtlasVert2*       mVertexStore;
   extern GFXVertexPCNT*       mVertexStorePCNT;
   extern GFXVertexPCNTT*      mVertexStorePCNTT;
   ...
   {
      GFXAtlasVert2 &pt = mVertexStore[mCurVertex];
   ...
   void end(MatInstance * m, SceneGraphData& sgData, vertexType vtype, Point4F *clipmapMapping, bool final, const MatrixF &blockTransform, const Point3F &cameraPosition, LightInfo *light);
	...
	//状态块
	extern GFXStateBlock* mCullCW;
	extern GFXStateBlock* mCullCCW;
