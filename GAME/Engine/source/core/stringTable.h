...
///
/// Only one _StringTable is ever instantiated in PowerEngine. It is accessible via the
/// global variable StringTable.
///
/// StringTable is used to manage strings in PowerEngine. It performs the following tasks:
