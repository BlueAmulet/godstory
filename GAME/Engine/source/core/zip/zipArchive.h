...
///        would be a blocking operation that would lock PowerEngine up for an appreciable
///        chunk of time.
...
/// 
/// The zip code included with stock PowerEngine supports "stored" (uncompressed) files
...
/// included with stock PowerEngine. BZip2 support will be released as a resource in
/// the future.
/// 
