...
{
   return ( U32( red   * 255.0f + 0.5) <<  24 ) |
          ( U32( green * 255.0f + 0.5) <<  16 ) |
          ( U32( blue  * 255.0f + 0.5) << 8 ) |
          ( U32( alpha * 255.0f + 0.5) << 0 );
}
...
inline void ColorI::setARGBPack(U32 pack)
{
	blue =   (U8)((pack & 0x000000FF)>>0);
	green = (U8)((pack & 0x0000FF00)>>8);
	red =  (U8)((pack & 0x00FF0000)>>16);
	alpha = (U8)((pack & 0xFF000000)>>24);
}
