...
#ifdef DECLARE_OVERLOADED_WRITE
...
#ifdef DECLARE_ENDIAN_OVERLOADED_READ
...
#ifdef DECLARE_ENDIAN_OVERLOADED_WRITE
...
class Stream {
  ...
  public:
   ...
   virtual void readString(char *stringBuf,int maxLen);
   ...
   bool write(const Point3F&);
   bool read(Point3F*);

   bool write(const MatrixF&);
   bool read(MatrixF*);
