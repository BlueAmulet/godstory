...
bool TheoraTexture::createVideoBuffers()
{
   ...
   mTextureHandle = new GFXTexHandle(NULL, bmp, true);
...
bool TheoraTexture::readyVideo(F64 dLastFrame, F64& dVBuffTime)
{
   ...
   while(1)
   {
      PROFILE_SCOPE(TheoraTexture_readyVideo);
...
#define BUFFERSIZE 8192
   ...
   while(1)
   {
      PROFILE_SCOPE(TheoraTexture_readyAudio);
...
#if defined(POWER_OS_MAC) && !defined(POWER_BIG_ENDIAN)
