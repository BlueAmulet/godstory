...
//--------------------------------------------------------------------------
class InteriorInstance : public RenderableSceneObject
{
  ...
  public:
   ...
   bool useSmoothLighting() {return(mSmoothLighting);}
...
//   Vector<MaterialList*>                mMaterialMaps;         ///< Materials for this interior
   ...
   bool                                 mSmoothLighting;       ///< Enables or disables doing the longer smooth lighting calculations
  ...
  public:
   ...
   SFXEnvironment * getAudioEnvironment() const { return mAudioEnvironment; }
