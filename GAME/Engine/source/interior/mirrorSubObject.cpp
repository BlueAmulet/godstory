...
//---------------------------------------------------------------------------
//#define STATEBLOCK
//GFXStateBlock* MirrorSubObject::mSetSB = NULL;
//GFXStateBlock* MirrorSubObject::mClearSB = NULL;
...
//
//void MirrorSubObject::resetStateBlock()
//{
//	////mSetSB
//	//GFX->beginStateBlock();
...
//
//
//void MirrorSubObject::releaseStateBlock()
//{
//	//if (mSetSB)
//	//{
//	//	mSetSB->release();
