                                        ...
                                        AbstractPolyList *poly, AtlasInstance *object)
{
   ...
   S32 xStart = (S32)mFloor((box.min.x - mBounds.min.x) / bucketSize.x);
   S32 yStart = (S32)mFloor((box.min.y - mBounds.min.y) / bucketSize.y);
   S32 xEnd   = (S32)mCeil((box.max.x - mBounds.min.x) / bucketSize.x);
   S32 yEnd   = (S32)mCeil((box.max.y - mBounds.min.y) / bucketSize.y);
