...
/// working in PowerEngine. It provides fundamental services allowing "smart"
...
///
/// You will spend a lot of your time in PowerEngine subclassing, or working
...
/// its ID). PowerEngine does this by keeping a global hierarchy of SimGroups -
...
/// deallocates itself.
///
/// @section simobject_editor PowerEngine Editors
///
...
/// PowerEngine codebase. Therefore, you probably don't need to be familiar
...
class SimObject: public ConsoleObject,public CVirtualAllocBase
{
...
public:
   ...
   /// Save object as a PowerEngineScript File.
   virtual bool		save(const char* pcFilePath, bool bOnlySelected=false);
   virtual bool		GhostAlwaysSave(const char* pcFilePath, bool bOnlySelected=false);
   ...
   virtual void deleteObject();     ///< Unregister, mark as deleted, and free the object.
   ///
   ...
   /// Output the PowerEngineScript to recreate this object.
   ///
   ...
   virtual void writeGhostAlways(Stream &stream, U32 tabStop, U32 flags = 0);
   virtual bool isGhostAlways() const {return false;}

   /// Write the fields of this object in PowerEngineScript.
   ///
   ...
   void setAdded(bool flag)  { if(flag) mFlags.set(Added); else mFlags.clear(Added); }
   ...
   /// Dump the contents of this object to the console.  Use the PowerEngine Script dump() and dumpF() functions to 
   /// call this.  
