...
///
/// Many of PowerEngine's subsystems, especially network, console, and sim,
...
///
/// PowerEngine supports a notion of group, type, and direction for objects passed over
...
///      DECLARE_CONOBJECT(PowerEngineObject);
///
/// // And this is from outside the class definition...
/// IMPLEMENT_CONOBJECT(PowerEngineObject);
/// @endcode
///
...
/// @code
///      // This is from inside the class definition...
///      static ConcreteClassRep<PowerEngineObject> dynClassRep;
...
/// @code
/// // And this is from outside the class definition...
/// AbstractClassRep* PowerEngineObject::getClassRep() const { return &PowerEngineObject::dynClassRep; }
/// AbstractClassRep* PowerEngineObject::getStaticClassRep() { return &dynClassRep; }
/// AbstractClassRep* PowerEngineObject::getParentStaticClassRep() { return Parent::getStaticClassRep(); }
/// ConcreteClassRep<PowerEngineObject> PowerEngineObject::dynClassRep("PowerEngineObject", 0, -1, 0);
/// @endcode
///
...
/// class rep.
///
/// In addition, dynClassRep is declared as a member of PowerEngineObject, and defined later
...
public:
   ...
   static void clear();		 // Called from Con::shutdown once on exit
   /// @}
};
...
/// class PowerEngineObject : public ConsoleObject {
...
/// IMPLEMENT_CONOBJECT(PowerEngineObject);
///
/// void PowerEngineObject::initPersistFields()
/// {
...
///   addField("sample", TypeS8, Offset(mSample, PowerEngineObject), "A test field.");
/// }
/// @endcode
///
...
/// @nosubgrouping
class ConsoleObject : public SimComponent
{
...
#ifdef POWER_DEBUG
   /// Overridden from SimComponent, in debug, to detect console method redirect
   /// conflicts.
