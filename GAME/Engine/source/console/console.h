...
struct EnumTable
{
   ...
   /// @see gAlignTable
   EnumTable(S32 sSize, const Enums *sTable)
...
///
/// The console is a key part of PowerEngine's architecture. It allows direct run-time control
...
namespace Con
{
   ...
   ///
   /// @note PowerEngine deals with this aspect of console management, so you don't need
   ...
   ///   - Calls AbstractClassRep::init() to initialize PowerEngine's class database.
   ...
   ///
   /// The console distributes its output through PowerEngine by using
   ...
   void addCommand(const char *name, IntCallback    cb,    const char *usage, S32 minArgs, S32 maxArg, bool toolOnly = false); ///< @copydoc addCommand(const char *, StringCallback, const char *, S32, S32)
   void addCommand(const char *name, FloatCallback  cb,  const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char *, StringCallback, const char *, S32, S32)
   void addCommand(const char *name, VoidCallback   cb,   const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char *, StringCallback, const char *, S32, S32)
   void addCommand(const char *name, BoolCallback   cb,   const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char *, StringCallback, const char *, S32, S32)
   /// @}
   ...
   void addCommand(const char *nameSpace, const char *name,IntCallback cb,    const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char*, const char *, StringCallback, const char *, S32, S32)
   void addCommand(const char *nameSpace, const char *name,FloatCallback cb,  const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char*, const char *, StringCallback, const char *, S32, S32)
   void addCommand(const char *nameSpace, const char *name,VoidCallback cb,   const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char*, const char *, StringCallback, const char *, S32, S32)
   void addCommand(const char *nameSpace, const char *name,BoolCallback cb,   const char *usage, S32 minArgs, S32 maxArgs, bool toolOnly = false); ///< @copydoc addCommand(const char*, const char *, StringCallback, const char *, S32, S32)
   /// @}
   ...
   /// @code
   /// // Call a PowerEngine script function called mAbs, having one parameter.
   /// char* argv[] = {"abs", "-9"};
...
#undef ARG
   ...
   /// Call a PowerEngine Script member function of a SimObject from C/C++ code.
...
///
/// @note If POWER_DEBUG is defined, then we gather documentation information, and
...
#define DECLARE_CONSOLE_CALLBACK(theType, name, args) \
   virtual theType name args
...
#  define ConsoleToolFunction(name,returnType,minArgs,maxArgs,usage1)                     \
   static returnType c##name(SimObject *, S32, const char **argv);                        \
   static ConsoleConstructor g##name##obj(NULL,#name,c##name,usage1,minArgs,maxArgs, true);     \
   static returnType c##name(SimObject *, S32 argc, const char **argv)
