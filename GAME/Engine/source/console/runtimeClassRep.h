...
/// This class is to allow new types to be added, at run-time, to PowerEngine.
...
public:
   ...
   /// Register this class with the PowerEngine console
   ...
   /// Unregister this class with the PowerEngine console
