...
private:
	...
	//force translate
	static GFXStateBlock* mForceTranslateSB;
	//z write
	...
	//z enable
	static GFXStateBlock* mZEnableSB;
	static GFXStateBlock* mZEnableFalseSB;
	//disable color
	static GFXStateBlock* mDisableColorSB;
	//enable blend color
	static GFXStateBlock* mEnableBlendColorSB;
	//cull mode
