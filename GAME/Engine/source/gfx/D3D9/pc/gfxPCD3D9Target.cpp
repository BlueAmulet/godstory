...
void GFXPCD3D9WindowTarget::initPresentationParams()
{
   ...
   mPresentationParams.PresentationInterval = D3DPRESENT_INTERVAL_ONE;	// This does NOT wait for vsync
...
bool GFXPCD3D9WindowTarget::present()
{
   ...
   HRESULT res = mSwapChain->Present(NULL, NULL, NULL, NULL, D3DPRESENT_DONOTWAIT);
...
void GFXPCD3D9WindowTarget::resetMode()
{
   ...
   else
   {
	   ...
	   //mDevice->setActiveRenderTarget( this );      
   }
