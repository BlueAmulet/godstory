...
inline static void _GFXInitGetInitialRes(GFXVideoMode&);
...
inline static void _GFXInitGetInitialRes(GFXVideoMode &vm)
{
   ...
   const bool kDefaultFullwindow = false;
   ...
   vm.resolution.x = PlatformWindow::getMinimum().x;
   vm.resolution.y = PlatformWindow::getMinimum().y;
