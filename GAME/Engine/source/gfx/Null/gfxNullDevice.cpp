...
{
protected:
      virtual GFXTextureObject *_createTexture(U32 height, U32 width, U32 depth, GFXFormat format, GFXTextureProfile *profile, U32 numMipLevels, bool forceMips = false)
      { 
...
GFXVertexBuffer *GFXNullDevice::allocVertexBuffer( U32 numVerts, U32 vertFlags, U32 vertSize, GFXBufferType bufferType,U8 streamNum ) 
{
...
void GFXNullDevice::enumerateAdapters( Vector<GFXAdapter*> &adapterList )
{
   ...
   dStrcpy(toAdd->mName, sizeof(toAdd->mName), "GFX Null Device");
