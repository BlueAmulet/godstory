...
#ifdef POWER_UNICODE
#  ifndef UNICODE
#     error "ERROR: You must have UNICODE defined in your preprocessor settings (ie, /DUNICODE) if you have POWER_UNICODE enabled in platform/EngineConfig.h!"
#  endif
#endif
...
#if defined(POWER_COMPILER_CODEWARRIOR)
