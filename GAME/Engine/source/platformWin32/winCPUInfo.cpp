...
#if defined(POWER_SUPPORTS_NASM)
...
#if defined(POWER_SUPPORTS_VC_INLINE_X86_ASM)
   __asm
   {
      //--------------------------------------
      // is CPUID supported
...
#elif defined(POWER_SUPPORTS_NASM)
...
// now calculate speed of processor...
...
#if defined(POWER_SUPPORTS_VC_INLINE_X86_ASM) || defined(POWER_COMPILER_MINGW)
   //--------------------------------------
   ...
   #if defined(POWER_COMPILER_MINGW)
      asm ("rdtsc" : "=a" (tsLo1), "=d" (tsHi1));
   #elif defined(POWER_SUPPORTS_VC_INLINE_X86_ASM)  // VC|CW
      __asm
      {
           push  eax
           push  edx
