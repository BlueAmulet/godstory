...
#include "lightingSystem/common/scenePersist.h"
#endif
...
public:
   ...
   virtual void sgNewEvent(U32 light, S32 object, U32 event);
	...
	bool saveDynamicShadowData(Stream &file);
	bool readDynamicShadowData(Stream *stream);
	...
	public:
      ...
      // Called to retreive the clip planes of the object.  Currently used for terrain lighting, but could be used to speed up other
