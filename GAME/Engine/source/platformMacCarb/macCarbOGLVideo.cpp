...
GLenum dumpGLDebugStr (void)
{
	...
	if (GL_NO_ERROR != err)
		Con::errorf ("got a gl error! yay!"); //(char *)gluErrorString(err));
   return err;
}
...
//  If for some reason we fail to get a default context, assert -- something's very wrong.
//-----------------------------------------------------------------------------------------
...
#pragma mark -
#pragma mark OpenGLDevice::initDevice()
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::enumDisplayModes
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::enumMonitors
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::chooseMonitor
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::activate
//------------------------------------------------------------------------------
// Activate
...
#pragma mark OpenGLDevice::cleanupContextAndWindow
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::shutdown
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::setScreenMode
//------------------------------------------------------------------------------
...
//   Platform::setWindowSize( newRes.w, newRes.h, smIsFullScreen );
...
#pragma mark OpenGLDevice::swapBuffers
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::getDriverInfo
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::getGammaCorrection
...
#pragma mark OpenGLDevice::setGammaCorrection
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::setVerticalSync
//------------------------------------------------------------------------------
...
#pragma mark OpenGLDevice::create
//------------------------------------------------------------------------------
...
#pragma mark Video::getDesktopResolution
