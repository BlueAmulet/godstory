...
class GuiTextListCtrl : public GuiArrayCtrl
{
  ...
  public:
   ...
   StringTableEntry	m_TextListBackgroundImageFile;		
   GFXTexHandle m_TextListBackgroundTexture;
  ...
  public:
   ...
   virtual void addEntryTakeColor(U32 id, const char *text,ColorI& color);
