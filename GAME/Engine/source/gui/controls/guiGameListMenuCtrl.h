...
public:
   ...
   static const S32 TEX_NORMAL      = 0;  ///< texture index for a normal, unselected row
   static const S32 TEX_SELECTED    = 1;  ///< texture index for a selected row
   static const S32 TEX_HIGHLIGHT   = 2;  ///< texture index for a highlighted row (moused over, not selected)
   static const S32 TEX_DISABLED    = 3;  ///< texture index for a disabled row
   static const S32 TEX_L_ARROW_OFF = 4;  ///< texture index for the left arrow of an unselected row
   static const S32 TEX_L_ARROW_ON  = 5;  ///< texture index for the left arrow of a selected row
   static const S32 TEX_R_ARROW_OFF = 6;  ///< texture index for the right arrow of an unselected row
   static const S32 TEX_R_ARROW_ON  = 7;  ///< texture index for the right arrow of a selected row

   static const S32 TEX_FIRST_ARROW = 4;  ///< texture index for the first arrow
   static const S32 TEX_FIRST_ICON  = 8;  ///< texture index for the first row marker icon
