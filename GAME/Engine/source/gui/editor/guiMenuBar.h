...
public:
   ...
   // <Edit>:[thinking]:按菜单字文本查找
	Menu *findMenu(const char *menu);  // takes either a menu text
	MenuItem *findMenuItem(Menu *menu, const char *menuItem); // takes either a menu text
	// <Edit>:[thinking]:按菜单ID查找
	Menu *findMenuID(const char *menu);// takes either a menu  a string id
	MenuItem *findMenuItemID(Menu *menu, const char *menuItem);//takes either a menu a string id
