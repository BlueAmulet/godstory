...
public:
	enum timer_type
	{
		WIN32_LOW_PERFORMANCE_TIMER,
		WIN32_HIGH_PERFORMANCE_TIMER
	};
...
public:
   ...
   virtual const S32 getElapsedUs()=0;
   
   /// Reset elapsed ms back to zero.
   virtual void reset()=0;
   
   /// Create a new PlatformTimer.
   static PlatformTimer *create(timer_type type = WIN32_LOW_PERFORMANCE_TIMER);
};
...
public:
   ...
   static S32 getDeltaTime(){ return smDeltaTime; } 
