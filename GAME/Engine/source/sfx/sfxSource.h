...
class SFXSource : public SimObject
{
   ...
   public:
      ...
      bool isLooping() const { return mLoopcount != 0; }
	  ...
	  U32 getPriory() const { return mPriority; }
	
	  SafePtr<SFXVoice> getVoice() const { return mVoice; }
	  SFXDescription* getDesc() const { return mDesc; }
};
