...
FMOD_FUNCTION(FMOD_System_Release, (FMOD_SYSTEM *syatem))
...
//<Editor>:iceRain Í¨µÀgroup
FMOD_FUNCTION(FMOD_System_CreateChannelGroup, (FMOD_SYSTEM *system, const char *name, FMOD_CHANNELGROUP **channelgroup))
FMOD_FUNCTION(FMOD_ChannelGroup_Release, (FMOD_CHANNELGROUP *channelgroup))
FMOD_FUNCTION(FMOD_ChannelGroup_GetVolume, (FMOD_CHANNELGROUP *channelgroup, float *volume))
FMOD_FUNCTION(FMOD_ChannelGroup_SetVolume, (FMOD_CHANNELGROUP *channelgroup, float volume))
FMOD_FUNCTION(FMOD_System_GetMasterChannelGroup,  (FMOD_SYSTEM *system, FMOD_CHANNELGROUP **channelgroup))
FMOD_FUNCTION(FMOD_ChannelGroup_AddGroup,  (FMOD_CHANNELGROUP *channelgroup, FMOD_CHANNELGROUP *group))
FMOD_FUNCTION(FMOD_Channel_SetChannelGroup,   (FMOD_CHANNEL *channel, FMOD_CHANNELGROUP *channelgroup))
FMOD_FUNCTION(FMOD_ChannelGroup_SetMute,  (FMOD_CHANNELGROUP *channelgroup, FMOD_BOOL mute))
FMOD_FUNCTION(FMOD_Channel_SetPriority, (FMOD_CHANNEL *channel, int priority))
FMOD_FUNCTION(FMOD_ChannelGroup_SetPaused, (FMOD_CHANNELGROUP *channelgroup, FMOD_BOOL paused))
FMOD_FUNCTION(FMOD_ChannelGroup_GetNumChannels, (FMOD_CHANNELGROUP *channelgroup, int *numchannels))
FMOD_FUNCTION(FMOD_ChannelGroup_GetChannel, (FMOD_CHANNELGROUP *channelgroup, int index, FMOD_CHANNEL **channel))
