...
///
/// GameBase adds two kinds of time-based updates. PowerEngine works off of a concept
...
///
/// PowerEngine maintains a server and a client processing list; in a local game, both
...
///
/// @nosubgrouping
class GameBase : public RenderableSceneObject, public ProcessObject
{
  private:
   ...
   /// @{
  protected:
   static GameBaseData msDataBlock;
  ...
  public:
   ...
   /// @name EffectPacketItems
   /// @{

   void addEffectItem(U32);
   void deleteEffectItem(U32);
   void clearEffectItem();
   /// @}
   ...
   void			setDataID(U32 dataid) { mDataBlockId = dataid;}
   U32			getDataID()	{ return mDataBlockId;}
   ...
   ///@}
   virtual bool  onChangeDataBlock(GameBaseData* dptr);
   ...
   virtual void beginAdvanceTime(F32 dt){return;}
   ...
   virtual bool useObjsEyePoint() { return false; }
   virtual bool onlyFirstPerson() { return false; }
   virtual F32 getDamageFlash() { return 1.0f; }
   virtual F32 getWhiteOut() { return 1.0f; }
   virtual void getCameraTransform(F32 *pos, MatrixF *mat) { *mat = MatrixF::smIdentity; }
