...
DECLARE_SERIALIBLE(MissionArea);
...
void MissionArea::OnSerialize( CTinyStream& stream )
{
	__super::OnSerialize( stream );

	stream << mArea;
	stream << mFlightCeiling;
	stream << mFlightCeilingRange;
}

void MissionArea::OnUnserialize( CTinyStream& stream )
{
