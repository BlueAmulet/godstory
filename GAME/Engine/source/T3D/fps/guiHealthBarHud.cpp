...
/// This gui displays the damage value of the current GameObjectType
...
/// connection exists and it's control object is a GameObjectType. If
...
void GuiHealthBarHud::onRender(Point2I offset, const RectI &updateRect)
{
   ...
   if (!control || !(control->getType() & GameObjectType))
      return;
