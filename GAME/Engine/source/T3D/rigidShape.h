...
class RigidShape: public ShapeBase
{
  ...
  protected:
   ...
   const static U64 PositionMask    = Parent::NextFreeMask << 0;
   const static U64 EnergyMask      = Parent::NextFreeMask << 1;
   const static U64 FreezeMask      = Parent::NextFreeMask << 2;
   const static U64 NextFreeMask    = Parent::NextFreeMask << 3;
