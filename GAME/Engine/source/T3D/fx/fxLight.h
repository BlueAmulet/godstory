...
#define FXLIGHTDBICONTEXTURE		"gameres/data/environments/lighting/fxlighticon.png"
...
protected:
	...
	enum {
		fxLightConfigChangeMask       = Parent::NextFreeMask << 1,
		fxLightAttachChange           = fxLightConfigChangeMask << 1,
	};
	...
	static char*            smIconTextureFilename;
...
private:
	static GFXStateBlock* mBlendZeroSB;
	static GFXStateBlock* mBlendOneSB;
	static GFXStateBlock* mBlendTwoSB;
	static GFXStateBlock* mTexOpSB;
	static GFXStateBlock* mBlendTexSB;
