...
// Class: fxSunLight
//------------------------------------------------------------------------------
class fxSunLight : public RenderableSceneObject
{
private:
...
private:
	//sun
	static GFXStateBlock* mLocalSunSB;
	static GFXStateBlock* mSunSB;
	//blend parameter
	static GFXStateBlock* mZeroSB;//add alpha
	static GFXStateBlock* mOneSB;//lerp alpha
	static GFXStateBlock* mTwoSB;//add
	//clear
