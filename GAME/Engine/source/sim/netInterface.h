...
protected:
   ...
   NetConnection *findPendingConnection(const NetAddress *address, int udpS, U32 packetSequence);
   ...
   void handleConnectChallengeResponse(const NetAddress *address, int udpS, BitStream *stream);
   ...
   void handleConnectAccept(const NetAddress *address, int udpS, BitStream *stream);
   ...
   void handleConnectReject(const NetAddress *address, int udpS, BitStream *stream);

   void handleDisconnect(const NetAddress *address, BitStream *stream);
   void handleDisconnect(const NetAddress *address, int udpS, BitStream *stream);
...
public:
   ...
   virtual void processPacketReceiveEventEx( NetAddress srcAddress, int udpSocket, RawData packetData );
