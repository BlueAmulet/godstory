...
class GFxEvent : public GNewOverrideBase
{
public:
    enum    EventType
    {
    ...
    GFxEvent(EventType eventType, GFxSpecialKeysState specialKeysState)
    {
        Type = eventType;
...
public:
    ...
    GFxKeyEvent(EventType eventType, GFxKey::Code code, UByte asciiCode, UInt32 wcharCode,
        GFxSpecialKeysState specialKeysState)
        : GFxEvent(eventType, specialKeysState), KeyCode (code), AsciiCode (asciiCode), WcharCode(wcharCode)
    { 
        GFC_DEBUG_EXPR(EventClassSize = sizeof(GFxKeyEvent));
    }
};
...
public:
    GFxSetFocusEvent(GFxSpecialKeysState specialKeysState) : 
      GFxEvent(SetFocus, specialKeysState) {}
};
