...
// Disable 'Date' class support.
//#define GFC_NO_FXPLAYER_AS_DATE

// Disable 'Point' class support.
//#define GFC_NO_FXPLAYER_AS_POINT

// Disable 'Rectangle' class support
//#define GFC_NO_FXPLAYER_AS_RECTANGLE

// Disable 'Transform' class support
//#define GFC_NO_FXPLAYER_AS_TRANSFORM

// Disable 'ColorTransform' class support
//#define GFC_NO_FXPLAYER_AS_COLORTRANSFORM

// Disable 'Matrix' class support
