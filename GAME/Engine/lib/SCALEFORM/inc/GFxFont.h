...
class GFxGlyphRaster : public GRefCountBase<GFxGlyphRaster>
{
public:
    GFxGlyphRaster() : Width(0), Height(0), OriginX(0), OriginY(0) {}

    GTL::garray<UByte> Raster;
    UInt               Width, Height;
...
public:
    ...
    {
        DontHint, // Don't apply naive hinting
    ...
    virtual GFxString   GetCharRanges() const { return ""; }
