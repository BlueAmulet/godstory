...
public:
    ...
    GImageBase(const GImageBase &src);
...
public:
    ...
    GEXPORT GImage(const GImageBase &src)
        : GRefCountBase<GImage>(), GImageBase(src)
    {}
...
/*
    ...
    static GImage*      GSTDCALL ReadSwfJpeg2(GFile* pin, GJPEGSystem *psystem = 0);
    ...
    static GImage*      GSTDCALL ReadSwfJpeg3(GFile* pin, GJPEGSystem *psystem = 0);
*/
