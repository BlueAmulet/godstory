...
#define GFC_FX_MINOR_VERSION        2
#define GFC_FX_BUILD_VERSION        61

#define GFC_FX_VERSION_STRING       "2.2.61"
...
#if defined(GFC_OS_MAC) || defined(GFC_OS_IPHONE)
...
template <typename T>   GINLINE int giround(const T a)
    { return (a > 0.0) ? (int)(a + 0.5) : (int)(a - 0.5); }

template <typename T>   GINLINE unsigned guround(const T a)
